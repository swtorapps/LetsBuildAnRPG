...
public class mainCharacterInfo : MonoBehaviour {
	...
	public int playerStrength, playerDefense, playerDexterity, playerSanity, playerReflexes, playerLevel, playerEXP;
	...
	void Start () {
		...
		playerName = PlayerPrefs.GetString ("characterName");
			...
			playerLevel = PlayerPrefs.GetInt ("characterLevel");
			playerEXP = PlayerPrefs.GetInt ("characterEXP");
